        ...
        <b-row class="mb-1">
          ...
          <b-col>
            <b-form inline>
              ...
              <b-form-input id="inline-form-input-age" min="10" placeholder="Enter your age" v-model="age" type="number" maxlenght="2"></b-form-input>
            </b-form>
          </b-col>
        </b-row>
        ...
        <b-row class="mb-1">
          ...
          <b-col>
            <b-form inline>
              ...
              <b-form-input id="inline-form-input-height" min="0" placeholder="Enter your height" v-model="height" type="number"></b-form-input>
            </b-form>
          </b-col>
        </b-row>
        ...
        <b-row>
          ...
          <b-col>
            <b-form inline>
              ...
              <b-form-input id="inline-form-input-weight" min="0" placeholder="Enter your weight" v-model="weight" type="number"></b-form-input>
            </b-form>
          </b-col>
        </b-row>
